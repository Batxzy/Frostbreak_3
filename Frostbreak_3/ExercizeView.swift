...
struct ExercisesView1: View {
    ...
    let exercises = [
        Exercise(
            title: "Veo veo",
            description: "Mira a lo lejos. Enfoca en un objeto distante por 20 segundos, luego cerca por 20 segundos."
        ),
        Exercise(
            title: "Ejercicio 20 20",
            description: "Mira algo a 20 pies (6 metros) durante 20 segundos, cada 20 minutos."
        ),
        Exercise(
            title: "Parpadeo",
            description: "Parpadea rápidamente durante 15 segundos, descansa 5 segundos y repite."
        )
    ]
    ...
    var body: some View {
        VStack(spacing: 0) {
            ScrollView {
                LazyVStack(spacing: 10) {
                    ForEach(exercises.indices, id: \.self) { index in
                        ExerciseRow2(exercise: exercises[index])
